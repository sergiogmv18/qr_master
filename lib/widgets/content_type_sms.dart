...
import 'package:qr_master/models/qr_type_sms.dart';
import 'package:qr_master/services/function_class.dart';

class ContentTypeSmS extends StatelessWidget {
  final QrRecord qrRecord;
  final Barcode? barcode;
  final String raw;
  final String formatted;
  final bool showData;
  const ContentTypeSmS({super.key, required this.qrRecord, required this.raw, this.showData = false, this.barcode, required this.formatted});

  @override
  Widget build(BuildContext context) {
    QrTypeSMS smsWk = QrTypeSMS.parseSmsToQrTypeSMS(raw);
    return Column(
      children: [
        Card(
...
// BODY 
                ...
                Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        FunctionsClass().copy(context: context, raw: smsWk.phoneNumber ?? "");
                      },
                      child:Icon(
                        Icons.copy,
...
// INITIAL DATE
                ...
                Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        FunctionsClass().copy(context: context, raw: smsWk.message ?? "");
                      },
                      child:Icon(
                        Icons.copy,
                        color: CustomColors.warning,

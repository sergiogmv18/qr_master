...
class ContentTypeLocation extends StatelessWidget {
  final QrRecord qrRecord;
  final Barcode? barcode;
  final String raw;
  final String formatted;
  final bool showData;
  const ContentTypeLocation({super.key, required this.qrRecord, required this.raw, this.showData = false, this.barcode, required this.formatted});
                  ...
                  child:RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(
                          text:": ${barcode?.format.name} - ${translate("location")}",
...
// SAVE
        ...
        PlanBadgeCard(
          ...
          onTap: () async{
            try {
                FunctionsClass().openAddressInMaps(raw, isGeo:true);
            } catch (e) {
              if(!context.mounted) return;
